   ...
   <div class="sticky top-0 z-40 ">
      <div class="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between">
         ...
         <div class="flex items-center relative ">
            ...
            <!-- dropdown menu -->
            <div class="absolute right-0 top-14 bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-lg w-48" :class="dropDownOpen ? '' : 'hidden'">
...
export default {
   setup() {
      ...
      return { toggleSidebar, store, dropDownOpen };
   },
};
</script>